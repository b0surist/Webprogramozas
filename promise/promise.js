function loadImage() {
    ...
    const imageUrl = `https://via.assets.so/game.jg?id=${id}`;
...
//2. ha kivszem akkor a kép URL-je ugyanaz marad nem változik
//3. annyival fogja az id számot növelni
//4. más fog kiírni, azt hogy: error
